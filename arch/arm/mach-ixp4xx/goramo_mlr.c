...
#define IRQ_ETHA		gpio_irq(GPIO_IRQ_ETHA)
#define IRQ_ETHB		gpio_irq(GPIO_IRQ_ETHB)
#define IRQ_NEC_CS5536		gpio_irq(GPIO_IRQ_NEC_CS5536)
#define IRQ_MPCI		gpio_irq(GPIO_IRQ_MPCI)
...
#define IRQ_CS5536_IDE		gpio_irq(0) /* CS5536 IRQ 14 - hardwired */
#define IRQ_CS5536_USB		gpio_irq(1) /* CS5536 IRQ 15 - IRQ mapper */
...
static void __init gmlr_pci_preinit(void)
{
	...
	set_irq_type(IRQ_NEC_CS5536, IRQ_TYPE_LEVEL_LOW);
...
/* Interrupts */
		...
		irq_to_desc(IRQ_NEC_CS5536)->status |= IRQ_LEVEL;
		set_irq_chained_handler(IRQ_NEC_CS5536, cs5536_irq_handler);
	}
}
