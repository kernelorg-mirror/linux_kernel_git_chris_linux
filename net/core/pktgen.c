...
#define F_PAYLOAD_RND (1<<16)	/* rest of the payload is pseudorandom */
	...
	if (!strcmp(name, "flag")) {
		...
		if (strcmp(f, "IPSRC_RND") == 0)
			...
			sprintf(pg_result,
				...
				"MACSRC_RND, MACDST_RND, TXSIZE_RND, IPV6, MPLS_RND, VID_RND, SVID_RND, FLOW_SEQ, QUEUE_MAP_RND, QUEUE_MAP_CPU, PAYLOAD_RND, IPSEC, NODE_ALLOC\n");
			return count;
		}
